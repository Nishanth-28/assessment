        ...
        <table  width="100%" height="100%">
            ...
            <tr height="78%">
                <td id="middle-wrap" valign="middle">
                    ...
                    <form:form method="POST" action="Registered" modelAttribute="registrationForm" onsubmit="return populateCountries()">
                         <table  height="100%" width="50%" align="left" rowspan="2">     
                            ...
                            <tr>
                               ...
                               <tr>
                                    <td><form:label path="organazationName">Organization Name*</form:label></td>
                                <td><form:input path="organazationName" /></td> 
                                <td><font color="red"> <form:errors path="organazationName"></form:errors></font></td>
                                </tr>
                                <tr>
                                    <td><form:label path="employees">No Of Employees*</form:label></td>

                                    <td><form:select path="employees">
                                        <form:option selected="selected"  value="" label="-- Choose one--"/>
                                        <form:options  items="${employee}"/>

                                    </form:select></td> 
                                <td><font color="red"> <form:errors path="employees"></form:errors></font></td>
                                </tr>
                                <tr>
                                ...
                                <td> <form:label path="countries" >Country*</form:label></td>
                            <td><form:select path="countries"  >
                                    <form:option selected="selected"  value="${country}" label="${country}"/> 
                                    <%--  <form:options  items="${registrationFormObject.country}"/>--%>
                                </form:select></td> 
       
                            <td><font color="red"> <form:errors path="countries"></form:errors></font></td>
                    </tr>
                    <tr>
                        <td><form:label path="states">State*</form:label></td>
                    <td><form:select path="states">
    
                             <form:option selected="selected"  value="${state}" label="${state}"/>
                            <%-- -<form:options   items="${registrationFormObject.state}"/>--%>
                        </form:select></td> 
                    <td><font color="red"> <form:errors path="states"></form:errors></font></td>
                    </tr>
                </table>  
                ...
                <table  height="100%" width="50%" align="right" rowspan="2">   
                    ...
                    <tr>
                        <td><form:label path="publicities">How did you hear about CloudJournee?</form:label></td>
                    <td><form:select path="publicities">
                            <form:option selected="selected"  value="" label="-- Choose one--"/> 

                            <form:options    items="${publicity}"/>
                ...
                <tr>
                    <td><form:label path="cloudAdaptions">Time lines for Cloud adoption</form:label></td>
                    <td><form:select path="cloudAdaptions" >
                            <form:option selected="selected"  value="" label="-- Choose one--"/> 
                            <form:options items="${cloudAdaption}"/>
                        </form:select></td> 
                </tr>

                <tr>
                    <td><form:label path="other">Any other?</form:label></td>
